...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT(
    ...
    KC_GRV,     JP_1,     JP_2,     JP_3,      JP_4,      JP_5,            JP_6,       JP_7,      JP_8,       JP_9,      KC_0,      JP_MINS,   JP_CIRC,   JP_YEN,     KC_BSPACE,   KC_INSERT,     KC_HOME,         KC_PGUP,
    KC_TAB,     KC_Q,     KC_W,     KC_E,      KC_R,      KC_T,            KC_Y,       KC_U,      KC_I,       KC_O,      KC_P,      JP_AT,     JP_LBRC,                            KC_DELETE,     KC_END,          KC_PGDOWN,
    KC_CAPSLOCK,KC_A,     KC_S,     KC_D,      KC_F,      KC_G,            KC_H,       KC_J,      KC_K,       KC_L,      JP_SCLN,   JP_COLN,   JP_RBRC,   KC_ENTER,
